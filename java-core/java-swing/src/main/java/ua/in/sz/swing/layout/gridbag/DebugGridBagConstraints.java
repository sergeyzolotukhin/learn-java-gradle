...
public class DebugGridBagConstraints implements Cloneable, java.io.Serializable {
     ...
     */
    public DebugGridBagConstraints () {
        gridx = RELATIVE;
        gridy = RELATIVE;
        gridwidth = 1;
        gridheight = 1;
     ...
     * @since 1.2
     */
    public DebugGridBagConstraints(int gridx, int gridy,
    ...
    public Object clone () {
        try {
            DebugGridBagConstraints c = (DebugGridBagConstraints)super.clone();
