...
public class ErgoUndertowServletWebServerFactory extends AbstractServletWebServerFactory
     ...
     */
    public ErgoUndertowServletWebServerFactory() {
     ...
     */
    public ErgoUndertowServletWebServerFactory(int port) {
        super(port);
        getJsp().setRegistered(false);
    }
     ...
     * @param port the port to listen on
     */
    public ErgoUndertowServletWebServerFactory(String contextPath, int port) {
     ...
     * apply additional processing to the {@link Undertow.Builder} and {@link DeploymentManager}
    ...
    protected UndertowServletWebServer getUndertowWebServer(Undertow.Builder builder, DeploymentManager manager, int port) {
        ...
        initialHandlerFactories.add(new ErgoDeploymentManagerHttpHandlerFactory(manager));
     ...
     * {@link Cookie.SameSite} cookie values.
     */
