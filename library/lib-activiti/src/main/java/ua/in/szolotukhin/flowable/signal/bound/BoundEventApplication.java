package ua.in.szolotukhin.flowable.signal.bound;
...
@Slf4j
public class BoundEventApplication {
	private static final String PARENT_PATH = "bound-event-parent.bpmn";
	private static final String CHILD_PATH = "bound-event-child.bpmn";
